      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            NutritionRow(
              'Carbohydrates: ',
              currentFood.carbohydrates_total_g,
              'g',
              setter: (newValue) =>
            ...
            NutritionRow(
              'Fats: ',
              currentFood.fat_total_g,
              'g',
              setter: (newValue) => currentFood.setFatTotalG = newValue,
              currentMeal: widget.currentMeal,
            ),
            MacroPieChart(currentFood.calories, currentFood.protein_g,
                currentFood.carbohydrates_total_g, currentFood.fat_total_g),
            const Padding(
              padding: EdgeInsets.all(12.0),
              child: Text(
                  style: TextStyle(
            ...
            NutritionRow(
              ...
              currentFood.fiber_g,
              'g',
              setter: (newValue) => currentFood.fiber_g = newValue,
              currentMeal: widget.currentMeal,
            ),
            NutritionRow(
              'Potassium: ',
              currentFood.potassium_mg,
              'mg',
              setter: (newValue) => currentFood.potassium_mg = newValue,
              currentMeal: widget.currentMeal,
            ),
            NutritionRow(
              'Serving Size: ',
              currentFood.serving_size_g,
              'g',
              setter: (newValue) => currentFood.serving_size_g = newValue,
              currentMeal: widget.currentMeal,
            ),
            NutritionRow(
              'Sodium: ',
              currentFood.sodium_mg,
              'mg',
              setter: (newValue) => currentFood.sodium_mg = newValue,
              currentMeal: widget.currentMeal,
            ),
            NutritionRow(
              'Sugar: ',
